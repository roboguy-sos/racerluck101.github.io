                ...
                <article className="glass glass-hover group relative h-full overflow-hidden p-6">
                  ...
                  <div className="mt-5">
                    {a.suffix === "%" ? (
                      ...
                      <p className="font-mono text-3xl font-bold text-white">{a.display}</p>
                    )}
                    <p className="mt-1 text-sm font-medium text-white/80">{a.title}</p>
                  </div>

                  <p className="mt-3 text-xs leading-relaxed text-white/50">{a.description}</p>
