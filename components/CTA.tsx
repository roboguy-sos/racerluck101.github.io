        ...
        <Reveal>
          <div className="glass relative overflow-hidden p-8 text-center sm:p-14">
            ...
            <div className="relative mx-auto max-w-2xl">
              <p className="eyebrow">
                <span className="text-accent">{"// "}</span>Hiring or scoping an engagement?
              </p>
              <h2 className="heading mt-4 text-3xl sm:text-4xl">
                Let&rsquo;s find your weak points before someone else does.
              </h2>
              <p className="mt-4 text-pretty text-sm leading-relaxed text-white/60 sm:text-base">
                Open to penetration testing, red team, and security engineering roles —
                full-time, contract, or freelance. Bring me your hardest targets.
              </p>
