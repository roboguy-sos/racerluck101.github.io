...
const focusAreas = [
    {
        ...
        text: "Web, network & identity exploitation across the full kill chain.",
    },
    {
        icon: Code2,
        title: "Secure Development",
        text: "Defense-in-depth applications and purpose-built offensive tooling.",
    },
    {
        icon: Bot,
        title: "AI Security Automation",
        text: "Agentic recon, LLM triage, and scalable security workflows.",
    },
    {
        icon: BookOpen,
        title: "Continuous Learning",
        text: "HTB, PortSwigger & live CTFs to stay ahead of the threat curve.",
    },
];
                        ...
                        <article className="glass h-full p-7 sm:p-9">
                            <div className="space-y-5">
                                {bio.map((para, i) => (
                                    <p
                                        key={i}
                                        className="text-pretty text-sm leading-relaxed text-white sm:text-base"
                                    >
                                        {para}
                                    </p>
                                ))}
